...
using SingnalRAndIldentity.Manager;
...
namespace SingnalRAndIldentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly RegistManager _registManager;
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                FormsAuthenticationTicket token = new FormsAuthenticationTicket(0, model.Email, DateTime.Now,
                    DateTime.Now.AddHours(1), true, string.Format("{0}&{1}", model.Email, model.Password),
                    FormsAuthentication.FormsCookiePath);

                var Token = FormsAuthentication.Encrypt(token);
                System.Web.HttpContext.Current.Session[model.Email] = Token;
                var strTicket = FormsAuthentication.Decrypt(Token).UserData;
                var name = System.Web.HttpContext.Current.User.Identity.Name;
                return RedirectToLocal("Home/Index?" + token + "");
            }
